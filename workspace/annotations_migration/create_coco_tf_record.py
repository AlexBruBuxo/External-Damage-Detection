...
Example usage:
    python create_coco_tf_record.py --logtostderr \
      --train_image_dir="coco_dataset/images/train/" \
      --val_image_dir="coco_dataset/images/val/" \
      --test_image_dir="coco_dataset/images/test/" \
      --train_annotations_file="coco_dataset/train.json" \
      --val_annotations_file="coco_dataset/val.json" \
      --testdev_annotations_file="coco_dataset/test.json" \
      --output_dir="tfrecord_dataset/"
"""
...
def create_tf_example(image,
  ...
  category_names = []
  category_ids = []
  # area = []  # --> removing as our COCO dataset does not have this field
  encoded_mask_png = []
  keypoints_x = []
  keypoints_y = []
  ...
  for object_annotations in annotations_list:
    ...
    # area.append(object_annotations['area'])  # --> removing as our COCO dataset does not have this field
  ...
  feature_dict = {
      ...
      # 'image/object/area':  # --> removing as our COCO dataset does not have this field
