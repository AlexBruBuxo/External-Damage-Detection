...
Author: https://github.com/akarazniewicz/cocosplit
Splits COCO annotations file into training and test sets.

usage: 
> python coco_split_annotations.py (--having-annotations) --multi-class -s 0.7 coco_labels.json coco_dataset/train.json coco_dataset/test_val.json
...
optional arguments:
  ...
  --multi-class         Split a multi-class dataset
"""
